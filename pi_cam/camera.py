...
#Uncomment to get a preview of what the camera sees.
#Be careful, if camera.start_preview() is called when the RPi starts up it will
#Cover the desktop and is a hassle to fix.
